 ...
 * @author Google, Inc.
 */
class WpmfGoogle_Service_Drive extends WpmfGoogle_Service
{
    ...
    public function __construct(WpmfGoogle_Client $client)
    {
        ...
        $this->about = new WpmfGoogle_Service_Drive_About_Resource(
            $this,
            $this->serviceName,
            'about',
            array(
        ...
        $this->changes = new WpmfGoogle_Service_Drive_Changes_Resource(
            $this,
            $this->serviceName,
            'changes',
            array(
        ...
        $this->channels = new WpmfGoogle_Service_Drive_Channels_Resource(
            $this,
            $this->serviceName,
            'channels',
            array(
        ...
        $this->comments = new WpmfGoogle_Service_Drive_Comments_Resource(
            $this,
            $this->serviceName,
            'comments',
            array(
        ...
        $this->drives = new WpmfGoogle_Service_Drive_Resource_Drives(
            $this,
            $this->serviceName,
            'drives',
            array(
        ...
        $this->files = new WpmfGoogle_Service_Drive_Files_Resource(
            $this,
            $this->serviceName,
            'files',
            array(
        ...
        $this->permissions = new WpmfGoogle_Service_Drive_Permissions_Resource(
            $this,
            $this->serviceName,
            'permissions',
            array(
        ...
        $this->replies = new WpmfGoogle_Service_Drive_Replies_Resource(
            $this,
            $this->serviceName,
            'replies',
            array(
        ...
        $this->revisions = new WpmfGoogle_Service_Drive_Revisions_Resource(
            $this,
            $this->serviceName,
            'revisions',
            array(
 ...
 * Typical usage is:
 *  <code>
 *   $driveService = new WpmfGoogle_Service_Drive(...);
 *   $about = $driveService->about;
 *  </code>
 */
class WpmfGoogle_Service_Drive_About_Resource extends WpmfGoogle_Service_Resource
{
     ...
     * @return WpmfGoogle_Service_Drive_About
     */
    public function get($optParams = array())
    {
        $params = array();
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), "WpmfGoogle_Service_Drive_About");
    }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Drive_Changes_Resource extends WpmfGoogle_Service_Resource
{
     ...
     *
     * @param array $optParams Optional parameters.
     * @return WpmfGoogle_Service_Drive_StartPageToken
     */
    public function getStartPageToken($optParams = array())
    {
        $params = array();
        $params = array_merge($params, $optParams);
        return $this->call('getStartPageToken', array($params), "WpmfGoogle_Service_Drive_StartPageToken");
    }
     ...
     * Drive.
     * @return WpmfGoogle_Service_Drive_ChangeList
     */
    public function listChanges($pageToken, $optParams = array())
    {
        $params = array('pageToken' => $pageToken);
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "WpmfGoogle_Service_Drive_ChangeList");
    }
     ...
     * the next page. This should be set to the value of 'nextPageToken' from the
     * previous response or to the response from the getStartPageToken method.
     * @param WpmfGoogle_Channel $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string spaces A comma-separated list of spaces to query within the
     * user corpus. Supported values are 'drive', 'appDataFolder' and 'photos'.
     ...
     * the Application Data folder or shared files which have not been added to My
     * Drive.
     * @return WpmfGoogle_Service_Drive_Channel
     */
    public function watch($pageToken, WpmfGoogle_Service_Drive_Channel $postBody, $optParams = array())
    {
        $params = array('pageToken' => $pageToken, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('watch', array($params), "WpmfGoogle_Service_Drive_Channel");
    }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Drive_Channels_Resource extends WpmfGoogle_Service_Resource
{
     ...
     * @param array $optParams Optional parameters.
     */
    public function stop(WpmfGoogle_Service_Drive_Channel $postBody, $optParams = array())
    {
 ...
 *  </code>
 */
class WpmfGoogle_Service_Drive_Comments_Resource extends WpmfGoogle_Service_Resource
{
     ...
     * @param WpmfGoogle_Comment $postBody
     * @param array $optParams Optional parameters.
     * @return WpmfGoogle_Service_Drive_Comment
     */
    public function create($fileId, WpmfGoogle_Service_Drive_Comment $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('create', array($params), "WpmfGoogle_Service_Drive_Comment");
    }
    ...
    public function get($fileId, $commentId, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'commentId' => $commentId);
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), "WpmfGoogle_Service_Drive_Comment");
    }
     ...
     * @return WpmfGoogle_Service_Drive_CommentList
     */
    public function listComments($fileId, $optParams = array())
    {
        $params = array('fileId' => $fileId);
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "WpmfGoogle_Service_Drive_CommentList");
    }
     ...
     * @return WpmfGoogle_Service_Drive_Comment
     */
    public function update($fileId, $commentId, WpmfGoogle_Service_Drive_Comment $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), "WpmfGoogle_Service_Drive_Comment");
    }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Drive_Resource_Drives extends WpmfGoogle_Service_Resource
{
    /**
     ...
     * @param WpmfGoogle_Service_Drive_Drive $postBody
     * @param array $optParams Optional parameters.
     * @return WpmfGoogle_Service_Drive_Drive
     */
    public function create($requestId, WpmfGoogle_Service_Drive_Drive $postBody, $optParams = array())
    {
        $params = array('requestId' => $requestId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('create', array($params), "WpmfGoogle_Service_Drive_Drive");
    }
    ...
    public function get($driveId, $optParams = array())
    {
        $params = array('driveId' => $driveId);
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), "WpmfGoogle_Service_Drive_Drive");
    }
    ...
    public function hide($driveId, $optParams = array())
    {
        $params = array('driveId' => $driveId);
        $params = array_merge($params, $optParams);
        return $this->call('hide', array($params), "WpmfGoogle_Service_Drive_Drive");
    }
    ...
    public function listDrives($optParams = array())
    {
        $params = array();
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "WpmfGoogle_Service_Drive_DriveList");
    }
    ...
    public function unhide($driveId, $optParams = array())
    {
        $params = array('driveId' => $driveId);
        $params = array_merge($params, $optParams);
        return $this->call('unhide', array($params), "WpmfGoogle_Service_Drive_Drive");
    }
    ...
    public function update($driveId, Google_Service_Drive_Drive $postBody, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), "WpmfGoogle_Service_Drive_Drive");
    }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Drive_Files_Resource extends WpmfGoogle_Service_Resource
{
     ...
     *
     * @param string $fileId The ID of the file.
     * @param WpmfGoogle_DriveFile $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     */
    public function copy($fileId, WpmfGoogle_Service_Drive_DriveFile $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('copy', array($params), "WpmfGoogle_Service_Drive_DriveFile");
    }
     ...
     * @return WpmfGoogle_Service_Drive_DriveFile
     */
    public function create(WpmfGoogle_Service_Drive_DriveFile $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('create', array($params), "WpmfGoogle_Service_Drive_DriveFile");
    }
    ...
    /**
     * Exports a Google Doc to the requested MIME type. (files.export)
     *
     * @param string $fileId The ID of the file.
     ...
     * @return WpmfGoogle_Service_Drive_GeneratedIds
     */
    public function generateIds($optParams = array())
    {
        $params = array();
        $params = array_merge($params, $optParams);
        return $this->call('generateIds', array($params), "WpmfGoogle_Service_Drive_GeneratedIds");
    }
    ...
    public function get($fileId, $optParams = array())
    {
        $params = array('fileId' => $fileId);
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), "WpmfGoogle_Service_Drive_DriveFile");
    }
     ...
     * @return WpmfGoogle_Service_Drive_FileList
     */
    public function listFiles($optParams = array())
    {
        $params = array();
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "WpmfGoogle_Service_Drive_FileList");
    }
     ...
     * @return WpmfGoogle_Service_Drive_DriveFile
     */
    public function update($fileId, WpmfGoogle_Service_Drive_DriveFile $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), "WpmfGoogle_Service_Drive_DriveFile");
    }
     ...
     * @return WpmfGoogle_Service_Drive_Channel
     */
    public function watch($fileId, WpmfGoogle_Service_Drive_Channel $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('watch', array($params), "WpmfGoogle_Service_Drive_Channel");
 ...
 *  </code>
 */
class WpmfGoogle_Service_Drive_Permissions_Resource extends WpmfGoogle_Service_Resource
{
     ...
     *
     * @param string $fileId The ID of the file.
     * @param WpmfGoogle_Permission $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return WpmfGoogle_Service_Drive_Permission
     */
    public function create($fileId, WpmfGoogle_Service_Drive_Permission $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('create', array($params), "WpmfGoogle_Service_Drive_Permission");
    }
    ...
    public function get($fileId, $permissionId, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'permissionId' => $permissionId);
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), "WpmfGoogle_Service_Drive_Permission");
    }
     ...
     * @param string $fileId The ID of the file.
     * @param array $optParams Optional parameters.
     * @return WpmfGoogle_Service_Drive_PermissionList
     */
    public function listPermissions($fileId, $optParams = array())
    {
        $params = array('fileId' => $fileId);
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "WpmfGoogle_Service_Drive_PermissionList");
    }
     ...
     * @return WpmfGoogle_Service_Drive_Permission
     */
    public function update($fileId, $permissionId, WpmfGoogle_Service_Drive_Permission $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'permissionId' => $permissionId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), "WpmfGoogle_Service_Drive_Permission");
    }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Drive_Replies_Resource extends WpmfGoogle_Service_Resource
{
     ...
     * @param string $fileId The ID of the file.
     * @param string $commentId The ID of the comment.
     * @param WpmfGoogle_Reply $postBody
     * @param array $optParams Optional parameters.
     * @return WpmfGoogle_Service_Drive_Reply
     */
    public function create($fileId, $commentId, WpmfGoogle_Service_Drive_Reply $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('create', array($params), "WpmfGoogle_Service_Drive_Reply");
    }
    ...
    public function get($fileId, $commentId, $replyId, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId);
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), "WpmfGoogle_Service_Drive_Reply");
    }
     ...
     * @return WpmfGoogle_Service_Drive_ReplyList
     */
    public function listReplies($fileId, $commentId, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'commentId' => $commentId);
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "WpmfGoogle_Service_Drive_ReplyList");
    }
     ...
     * @return WpmfGoogle_Service_Drive_Reply
     */
    public function update($fileId, $commentId, $replyId, WpmfGoogle_Service_Drive_Reply $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), "WpmfGoogle_Service_Drive_Reply");
    }
}
 ...
 *  </code>
 */
class WpmfGoogle_Service_Drive_Revisions_Resource extends WpmfGoogle_Service_Resource
{
     ...
     * of downloading known malware or other abusive files. This is only applicable
     * when alt=media.
     * @return WpmfGoogle_Service_Drive_Revision
     */
    public function get($fileId, $revisionId, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'revisionId' => $revisionId);
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), "WpmfGoogle_Service_Drive_Revision");
    }
     ...
     * @param string $fileId The ID of the file.
     * @param array $optParams Optional parameters.
     * @return WpmfGoogle_Service_Drive_RevisionList
     */
    public function listRevisions($fileId, $optParams = array())
    {
        $params = array('fileId' => $fileId);
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), "WpmfGoogle_Service_Drive_RevisionList");
    }
     ...
     * @param string $fileId The ID of the file.
     * @param string $revisionId The ID of the revision.
     * @param WpmfGoogle_Revision $postBody
     * @param array $optParams Optional parameters.
     * @return WpmfGoogle_Service_Drive_Revision
     */
    public function update($fileId, $revisionId, WpmfGoogle_Service_Drive_Revision $postBody, $optParams = array())
    {
        $params = array('fileId' => $fileId, 'revisionId' => $revisionId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), "WpmfGoogle_Service_Drive_Revision");
    }
}


class WpmfGoogle_Service_Drive_About extends WpmfGoogle_Collection
{
    ...
    protected $storageQuotaType = 'WpmfGoogle_Service_Drive_AboutStorageQuota';
    protected $storageQuotaDataType = '';
    protected $userType = 'WpmfGoogle_Service_Drive_User';
    ...
    public function setStorageQuota(WpmfGoogle_Service_Drive_AboutStorageQuota $storageQuota)
    {
    ...
    public function setUser(WpmfGoogle_Service_Drive_User $user)
    {
        $this->user = $user;
    }
...
class WpmfGoogle_Service_Drive_AboutExportFormats extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Drive_AboutImportFormats extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Drive_AboutMaxImportSizes extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Drive_AboutStorageQuota extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $limit;
    public $usage;
...
class WpmfGoogle_Service_Drive_Change extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    protected $fileType = 'WpmfGoogle_Service_Drive_DriveFile';
    ...
    public function setFile(WpmfGoogle_Service_Drive_DriveFile $file)
    {
        $this->file = $file;
    }
...
class WpmfGoogle_Service_Drive_ChangeList extends WpmfGoogle_Collection
{
    protected $collection_key = 'changes';
    protected $internal_gapi_mappings = array();
    protected $changesType = 'WpmfGoogle_Service_Drive_Change';
...
class WpmfGoogle_Service_Drive_Channel extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $address;
    public $expiration;
...
class WpmfGoogle_Service_Drive_ChannelParams extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Drive_Comment extends WpmfGoogle_Collection
{
    protected $collection_key = 'replies';
    protected $internal_gapi_mappings = array();
    public $anchor;
    protected $authorType = 'WpmfGoogle_Service_Drive_User';
    ...
    public $kind;
    public $modifiedTime;
    protected $quotedFileContentType = 'WpmfGoogle_Service_Drive_CommentQuotedFileContent';
    protected $quotedFileContentDataType = '';
    protected $repliesType = 'WpmfGoogle_Service_Drive_Reply';
    ...
    public function setAuthor(WpmfGoogle_Service_Drive_User $author)
    {
        $this->author = $author;
    }
    ...
    public function setQuotedFileContent(WpmfGoogle_Service_Drive_CommentQuotedFileContent $quotedFileContent)
    {
...
class WpmfGoogle_Service_Drive_DriveList extends WpmfGoogle_Collection
{
    protected $collection_key = 'drives';
    protected $drivesType = 'WpmfGoogle_Service_Drive_Drive';
    protected $drivesDataType = 'array';
    public $kind;
    public $nextPageToken;

    /**
     * @param WpmfGoogle_Service_Drive_Drive
     */
...
class WpmfGoogle_Service_Drive_CommentList extends WpmfGoogle_Collection
{
    protected $collection_key = 'comments';
    protected $internal_gapi_mappings = array();
    protected $commentsType = 'WpmfGoogle_Service_Drive_Comment';
...
class WpmfGoogle_Service_Drive_DriveBackgroundImageFile extends WpmfGoogle_Model
{
    public $id;
    public $width;
    public $xCoordinate;
...
class WpmfGoogle_Service_Drive_DriveCapabilities extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_Drive_DriveRestrictions extends WpmfGoogle_Model
{
...
class WpmfGoogle_Service_Drive_Drive extends WpmfGoogle_Model
{
    protected $backgroundImageFileType = 'WpmfGoogle_Service_Drive_DriveBackgroundImageFile';
    protected $backgroundImageFileDataType = '';
    public $backgroundImageLink;
    protected $capabilitiesType = 'WpmfGoogle_Service_Drive_DriveCapabilities';
    ...
    public $kind;
    public $name;
    protected $restrictionsType = 'WpmfGoogle_Service_Drive_DriveRestrictions';
    protected $restrictionsDataType = '';
    public $themeId;

    /**
     * @param WpmfGoogle_Service_Drive_DriveBackgroundImageFile
     */
    public function setBackgroundImageFile(WpmfGoogle_Service_Drive_DriveBackgroundImageFile $backgroundImageFile)
    {
        $this->backgroundImageFile = $backgroundImageFile;
    }

    /**
     * @return WpmfGoogle_Service_Drive_DriveBackgroundImageFile
     */
    ...
    /**
     * @param WpmfGoogle_Service_Drive_DriveCapabilities
     */
    public function setCapabilities(WpmfGoogle_Service_Drive_DriveCapabilities $capabilities)
    {
        $this->capabilities = $capabilities;
    }

    /**
     * @return WpmfGoogle_Service_Drive_DriveCapabilities
     */
    ...
    /**
     * @param WpmfGoogle_Service_Drive_DriveRestrictions
     */
    public function setRestrictions(WpmfGoogle_Service_Drive_DriveRestrictions $restrictions)
    {
        $this->restrictions = $restrictions;
    }

    /**
     * @return WpmfGoogle_Service_Drive_DriveRestrictions
     */
...
class WpmfGoogle_Service_Drive_CommentQuotedFileContent extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $mimeType;
    public $value;
...
class WpmfGoogle_Service_Drive_DriveFile extends WpmfGoogle_Collection
{
    protected $collection_key = 'spaces';
    protected $internal_gapi_mappings = array();
    public $appProperties;
    protected $capabilitiesType = 'WpmfGoogle_Service_Drive_DriveFileCapabilities';
    protected $capabilitiesDataType = '';
    protected $contentHintsType = 'WpmfGoogle_Service_Drive_DriveFileContentHints';
    ...
    public $iconLink;
    public $id;
    protected $imageMediaMetadataType = 'WpmfGoogle_Service_Drive_DriveFileImageMediaMetadata';
    protected $imageMediaMetadataDataType = '';
    public $kind;
    protected $lastModifyingUserType = 'WpmfGoogle_Service_Drive_User';
    ...
    public $ownedByMe;
    protected $ownersType = 'WpmfGoogle_Service_Drive_User';
    protected $ownersDataType = 'array';
    public $parents;
    protected $permissionsType = 'WpmfGoogle_Service_Drive_Permission';
    protected $permissionsDataType = 'array';
    public $properties;
    public $quotaBytesUsed;
    public $shared;
    public $sharedWithMeTime;
    protected $sharingUserType = 'WpmfGoogle_Service_Drive_User';
    ...
    public $trashed;
    public $version;
    protected $videoMediaMetadataType = 'WpmfGoogle_Service_Drive_DriveFileVideoMediaMetadata';
    ...
    public function setCapabilities(WpmfGoogle_Service_Drive_DriveFileCapabilities $capabilities)
    {
        $this->capabilities = $capabilities;
    }
    ...
    public function setContentHints(WpmfGoogle_Service_Drive_DriveFileContentHints $contentHints)
    {
    ...
    public function setImageMediaMetadata(WpmfGoogle_Service_Drive_DriveFileImageMediaMetadata $imageMediaMetadata)
    {
    ...
    public function setLastModifyingUser(WpmfGoogle_Service_Drive_User $lastModifyingUser)
    {
    ...
    public function setSharingUser(WpmfGoogle_Service_Drive_User $sharingUser)
    {
    ...
    public function setVideoMediaMetadata(WpmfGoogle_Service_Drive_DriveFileVideoMediaMetadata $videoMediaMetadata)
    {
...
class WpmfGoogle_Service_Drive_DriveFileAppProperties extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Drive_DriveFileCapabilities extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $canComment;
    public $canCopy;
...
class WpmfGoogle_Service_Drive_DriveFileContentHints extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $indexableText;
    protected $thumbnailType = 'WpmfGoogle_Service_Drive_DriveFileContentHintsThumbnail';
    ...
    public function setThumbnail(WpmfGoogle_Service_Drive_DriveFileContentHintsThumbnail $thumbnail)
    {
...
class WpmfGoogle_Service_Drive_DriveFileContentHintsThumbnail extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $image;
    public $mimeType;
...
class WpmfGoogle_Service_Drive_DriveFileImageMediaMetadata extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $aperture;
    public $cameraMake;
    ...
    public $isoSpeed;
    public $lens;
    protected $locationType = 'WpmfGoogle_Service_Drive_DriveFileImageMediaMetadataLocation';
    ...
    public function setLocation(WpmfGoogle_Service_Drive_DriveFileImageMediaMetadataLocation $location)
    {
...
class WpmfGoogle_Service_Drive_DriveFileImageMediaMetadataLocation extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $altitude;
    public $latitude;
...
class WpmfGoogle_Service_Drive_DriveFileProperties extends WpmfGoogle_Model
{
}

class WpmfGoogle_Service_Drive_DriveFileVideoMediaMetadata extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
...
class WpmfGoogle_Service_Drive_FileList extends WpmfGoogle_Collection
{
    protected $collection_key = 'files';
    protected $internal_gapi_mappings = array();
    protected $filesType = 'WpmfGoogle_Service_Drive_DriveFile';
...
class WpmfGoogle_Service_Drive_GeneratedIds extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Drive_Permission extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
...
class WpmfGoogle_Service_Drive_PermissionList extends WpmfGoogle_Collection
{
...
class WpmfGoogle_Service_Drive_Reply extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $action;
    protected $authorType = 'WpmfGoogle_Service_Drive_User';
...
class WpmfGoogle_Service_Drive_ReplyList extends WpmfGoogle_Collection
{
    protected $collection_key = 'replies';
    protected $internal_gapi_mappings = array();
    public $kind;
...
class WpmfGoogle_Service_Drive_Revision extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $id;
    public $keepForever;
...
class WpmfGoogle_Service_Drive_RevisionList extends WpmfGoogle_Collection
{
    protected $collection_key = 'revisions';
    protected $internal_gapi_mappings = array();
    public $kind;
    protected $revisionsType = 'WpmfGoogle_Service_Drive_Revision';
...
class WpmfGoogle_Service_Drive_StartPageToken extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $kind;
...
class WpmfGoogle_Service_Drive_User extends WpmfGoogle_Model
{
    protected $internal_gapi_mappings = array();
    public $displayName;
    public $emailAddress;
