...
class RetryMiddleware
{
    ...
    private function onFulfilled(\WP_Media_Folder\Psr\Http\Message\RequestInterface $req, array $options)
    {
    ...
    private function onRejected(\WP_Media_Folder\Psr\Http\Message\RequestInterface $req, array $options)
    {
    ...
    private function doRetry(\WP_Media_Folder\Psr\Http\Message\RequestInterface $request, array $options, \WP_Media_Folder\Psr\Http\Message\ResponseInterface $response = null)
    {
