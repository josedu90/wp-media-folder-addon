 ...
 */
class Promise implements \WP_Media_Folder\GuzzleHttp\Promise\PromiseInterface
{
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        if ($this->state === self::PENDING) {
            $p = new \WP_Media_Folder\GuzzleHttp\Promise\Promise(null, [$this, 'cancel']);
    ...
    public function cancel()
    {
        ...
        if ($this->state === self::PENDING) {
            $this->reject(new \WP_Media_Folder\GuzzleHttp\Promise\CancellationException('Promise has been cancelled'));
        }
    }
