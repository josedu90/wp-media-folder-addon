 ...
 */
class MultipartStream implements \WP_Media_Folder\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \WP_Media_Folder\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\WP_Media_Folder\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \WP_Media_Folder\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
