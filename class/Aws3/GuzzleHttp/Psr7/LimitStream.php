 ...
 */
class LimitStream implements \WP_Media_Folder\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\WP_Media_Folder\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
