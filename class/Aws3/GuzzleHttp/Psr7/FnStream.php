 ...
 */
class FnStream implements \WP_Media_Folder\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\WP_Media_Folder\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
