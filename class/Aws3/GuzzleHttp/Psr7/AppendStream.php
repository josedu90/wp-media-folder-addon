 ...
 */
class AppendStream implements \WP_Media_Folder\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\WP_Media_Folder\Psr\Http\Message\StreamInterface $stream)
    {
