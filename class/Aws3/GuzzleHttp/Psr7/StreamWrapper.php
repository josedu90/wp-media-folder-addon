...
class StreamWrapper
{
     ...
     */
    public static function getResource(\WP_Media_Folder\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\WP_Media_Folder\Psr\Http\Message\StreamInterface $stream)
    {
