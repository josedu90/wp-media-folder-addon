...
class AstRuntime
{
    ...
    public function __construct(\WP_Media_Folder\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \WP_Media_Folder\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \WP_Media_Folder\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \WP_Media_Folder\JmesPath\Parser();
    }
    /**
