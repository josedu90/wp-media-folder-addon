...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \WP_Media_Folder\JmesPath\Lexer();
        $this->parser = new \WP_Media_Folder\JmesPath\Parser($this->lexer);
    }
    ...
    {
        $lexer = new \WP_Media_Folder\JmesPath\Lexer();
    ...
    {
        $parser = new \WP_Media_Folder\JmesPath\Parser();
