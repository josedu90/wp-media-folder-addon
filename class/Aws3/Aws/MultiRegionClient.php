...
use WP_Media_Folder\Aws\Endpoint\PartitionInterface;
class MultiRegionClient implements \WP_Media_Folder\Aws\AwsClientInterface
{
    use AwsClientTrait;
    ...
    {
        $args = array_intersect_key(\WP_Media_Folder\Aws\ClientResolver::getDefaultArguments(), ['service' => true, 'region' => true]);
        ...
        return $args + ['client_factory' => ['type' => 'config', 'valid' => ['callable'], 'doc' => 'A callable that takes an array of client' . ' configuration arguments and returns a regionalized' . ' client.', 'required' => true, 'internal' => true, 'default' => function (array $args) {
            ...
            $klass = "WP_Media_Folder\\Aws\\{$namespace}\\{$namespace}Client";
        ...
        }], 'partition' => ['type' => 'config', 'valid' => ['string', \WP_Media_Folder\Aws\Endpoint\PartitionInterface::class], 'doc' => 'AWS partition to connect to. Valid partitions' . ' include "aws," "aws-cn," and "aws-us-gov." Used to' . ' restrict the scope of the mapRegions method.', 'default' => function (array $args) {
            $region = isset($args['region']) ? $args['region'] : '';
            return \WP_Media_Folder\Aws\Endpoint\PartitionEndpointProvider::defaultProvider()->getPartition($region, $args['service']);
        }, 'fn' => function ($value, array &$args) {
            if (is_string($value)) {
                $value = \WP_Media_Folder\Aws\Endpoint\PartitionEndpointProvider::defaultProvider()->getPartitionByName($value);
            }
    ...
    public function __construct(array $args = [])
    {
        ...
        $this->handlerList = new \WP_Media_Folder\Aws\HandlerList(function (\WP_Media_Folder\Aws\CommandInterface $command) {
        ...
        $resolver = new \WP_Media_Folder\Aws\ClientResolver($argDefinitions);
