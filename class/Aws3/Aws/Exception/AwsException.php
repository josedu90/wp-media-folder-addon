 ...
 */
class AwsException extends \RuntimeException implements \WP_Media_Folder\Aws\MonitoringEventsInterface, \WP_Media_Folder\Aws\ResponseContainerInterface
{
     ...
     */
    public function __construct($message, \WP_Media_Folder\Aws\CommandInterface $command, array $context = [], \Exception $previous = null)
    {
