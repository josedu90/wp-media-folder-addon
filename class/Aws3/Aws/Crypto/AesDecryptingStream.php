 ...
 */
class AesDecryptingStream implements \WP_Media_Folder\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\WP_Media_Folder\Psr\Http\Message\StreamInterface $cipherText, $key, \WP_Media_Folder\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
