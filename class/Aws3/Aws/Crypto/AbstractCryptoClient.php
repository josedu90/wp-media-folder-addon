...
use WP_Media_Folder\Aws\Crypto\Cipher\CipherMethod;
use WP_Media_Folder\Aws\Crypto\Cipher\Cbc;
...
abstract class AbstractCryptoClient
{
     ...
     * @internal
     */
    public abstract function encrypt(\WP_Media_Folder\GuzzleHttp\Psr7\Stream $plaintext, array $cipherOptions, \WP_Media_Folder\Aws\Crypto\MaterialsProvider $provider, \WP_Media_Folder\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \WP_Media_Folder\Aws\Crypto\MaterialsProvider $provider, \WP_Media_Folder\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
