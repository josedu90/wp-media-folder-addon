 ...
 */
class CommandPool implements \WP_Media_Folder\GuzzleHttp\Promise\PromisorInterface
{
    /** @var EachPromise */
    private $each;
    /**
     ...
     */
    public function __construct(\WP_Media_Folder\Aws\AwsClientInterface $client, $commands, array $config = [])
    {
        ...
        $this->each = new \WP_Media_Folder\GuzzleHttp\Promise\EachPromise($mapFn($commands), $config);
    }
    /**
     ...
     */
    public static function batch(\WP_Media_Folder\Aws\AwsClientInterface $client, $commands, array $config = [])
    {
        $results = [];
