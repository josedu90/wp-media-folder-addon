 ...
 */
class HashingStream implements \WP_Media_Folder\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\WP_Media_Folder\Psr\Http\Message\StreamInterface $stream, \WP_Media_Folder\Aws\HashInterface $hash, callable $onComplete = null)
    {
        $this->stream = $stream;
        $this->hash = $hash;
