 ...
 * @internal
 */
class ApiCallMonitoringMiddleware extends \WP_Media_Folder\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
    ...
    private static function getResultAttemptCount(\WP_Media_Folder\Aws\ResultInterface $result)
    {
