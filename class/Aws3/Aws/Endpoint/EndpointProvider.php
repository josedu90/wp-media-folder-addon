...
namespace WP_Media_Folder\Aws\Endpoint;

use WP_Media_Folder\Aws\Exception\UnresolvedEndpointException;
/**
 * Endpoint providers.
 *
...
class EndpointProvider
{
    ...
    public static function resolve(callable $provider, array $args = [])
    {
        ...
        throw new \WP_Media_Folder\Aws\Exception\UnresolvedEndpointException('Unable to resolve an endpoint using the provider arguments: ' . json_encode($args) . '. Note: you can provide an "endpoint" ' . 'option to a client constructor to bypass invoking an endpoint ' . 'provider.');
    }
    /**
    ...
    {
        return \WP_Media_Folder\Aws\Endpoint\PartitionEndpointProvider::defaultProvider();
    }
    /**
    ...
    {
        return new \WP_Media_Folder\Aws\Endpoint\PatternEndpointProvider($patterns);
    }
}
