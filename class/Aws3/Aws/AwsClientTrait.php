...
trait AwsClientTrait
{
    public function getPaginator($name, array $args = [])
    {
        ...
        return new \WP_Media_Folder\Aws\ResultPaginator($this, $name, $args, $config);
    }
    ...
    public function getWaiter($name, array $args = [])
    {
        ...
        return new \WP_Media_Folder\Aws\Waiter($this, $name, $args, $config);
    }
    public function execute(\WP_Media_Folder\Aws\CommandInterface $command)
    {
        return $this->executeAsync($command)->wait();
    }
    public function executeAsync(\WP_Media_Folder\Aws\CommandInterface $command)
    {
