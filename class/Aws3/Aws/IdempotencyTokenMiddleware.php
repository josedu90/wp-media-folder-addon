...
class IdempotencyTokenMiddleware
{
     ...
     * @return callable
     */
    public static function wrap(\WP_Media_Folder\Aws\Api\Service $service, callable $bytesGenerator = null)
    {
        return function (callable $handler) use($service, $bytesGenerator) {
            return new self($handler, $service, $bytesGenerator);
        };
    }
    public function __construct(callable $nextHandler, \WP_Media_Folder\Aws\Api\Service $service, callable $bytesGenerator = null)
    {
