...
class JsonBody
{
     ...
     * @return string
     */
    public static function getContentType(\WP_Media_Folder\Aws\Api\Service $service)
    {
    ...
    private function format(\WP_Media_Folder\Aws\Api\Shape $shape, $value)
    {
        switch ($shape['type']) {
            case 'structure':
                $data = [];
            ...
            case 'timestamp':
                ...
                return \WP_Media_Folder\Aws\Api\TimestampShape::format($value, $timestampFormat);
            default:
                return $value;
        }
    }
