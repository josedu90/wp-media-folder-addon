...
class XmlBody
{
     ...
     * @return string
     */
    public function build(\WP_Media_Folder\Aws\Api\Shape $shape, array $args)
    {
        $xml = new \XMLWriter();
        $xml->openMemory();
    ...
    private function startElement(\WP_Media_Folder\Aws\Api\Shape $shape, $name, \XMLWriter $xml)
    {
    ...
    private function format(\WP_Media_Folder\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
    ...
    private function defaultShape(\WP_Media_Folder\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
        $xml->writeRaw($value);
        $xml->endElement();
    }
    private function add_structure(\WP_Media_Folder\Aws\Api\StructureShape $shape, $name, array $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
    ...
    private function getStructureMembers(\WP_Media_Folder\Aws\Api\StructureShape $shape, array $value)
    {
        $members = [];
    ...
    private function add_list(\WP_Media_Folder\Aws\Api\ListShape $shape, $name, array $value, \XMLWriter $xml)
    {
    ...
    private function add_map(\WP_Media_Folder\Aws\Api\MapShape $shape, $name, array $value, \XMLWriter $xml)
    {
    ...
    private function add_blob(\WP_Media_Folder\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
        $xml->writeRaw(base64_encode($value));
        $xml->endElement();
    }
    private function add_timestamp(\WP_Media_Folder\Aws\Api\TimestampShape $shape, $name, $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
        $timestampFormat = !empty($shape['timestampFormat']) ? $shape['timestampFormat'] : 'iso8601';
        $xml->writeRaw(\WP_Media_Folder\Aws\Api\TimestampShape::format($value, $timestampFormat));
        $xml->endElement();
    }
    private function add_boolean(\WP_Media_Folder\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
        $xml->writeRaw($value ? 'true' : 'false');
        $xml->endElement();
    }
    private function add_string(\WP_Media_Folder\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
