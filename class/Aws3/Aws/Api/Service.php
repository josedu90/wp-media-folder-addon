...
use WP_Media_Folder\Aws\Api\Serializer\QuerySerializer;
use WP_Media_Folder\Aws\Api\Serializer\Ec2ParamBuilder;
use WP_Media_Folder\Aws\Api\Parser\QueryParser;
/**
 * Represents a web service API model.
 */
class Service extends \WP_Media_Folder\Aws\Api\AbstractModel
{
    /** @var callable */
    private $apiProvider;
    /** @var string */
    ...
    public function __construct(array $definition, callable $provider)
    {
        ...
        parent::__construct($definition, new \WP_Media_Folder\Aws\Api\ShapeMap($definition['shapes']));
     ...
     */
    public static function createSerializer(\WP_Media_Folder\Aws\Api\Service $api, $endpoint)
    {
        static $mapping = ['json' => 'WP_Media_Folder\\Aws\\Api\\Serializer\\JsonRpcSerializer', 'query' => 'WP_Media_Folder\\Aws\\Api\\Serializer\\QuerySerializer', 'rest-json' => 'WP_Media_Folder\\Aws\\Api\\Serializer\\RestJsonSerializer', 'rest-xml' => 'WP_Media_Folder\\Aws\\Api\\Serializer\\RestXmlSerializer'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api, $endpoint);
        }
        if ($proto == 'ec2') {
            return new \WP_Media_Folder\Aws\Api\Serializer\QuerySerializer($api, $endpoint, new \WP_Media_Folder\Aws\Api\Serializer\Ec2ParamBuilder());
        }
    ...
    {
        static $mapping = ['json' => 'WP_Media_Folder\\Aws\\Api\\ErrorParser\\JsonRpcErrorParser', 'query' => 'WP_Media_Folder\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'rest-json' => 'WP_Media_Folder\\Aws\\Api\\ErrorParser\\RestJsonErrorParser', 'rest-xml' => 'WP_Media_Folder\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'ec2' => 'WP_Media_Folder\\Aws\\Api\\ErrorParser\\XmlErrorParser'];
     ...
     * @throws \UnexpectedValueException
     */
    public static function createParser(\WP_Media_Folder\Aws\Api\Service $api)
    {
        static $mapping = ['json' => 'WP_Media_Folder\\Aws\\Api\\Parser\\JsonRpcParser', 'query' => 'WP_Media_Folder\\Aws\\Api\\Parser\\QueryParser', 'rest-json' => 'WP_Media_Folder\\Aws\\Api\\Parser\\RestJsonParser', 'rest-xml' => 'WP_Media_Folder\\Aws\\Api\\Parser\\RestXmlParser'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api);
        }
        if ($proto == 'ec2') {
            return new \WP_Media_Folder\Aws\Api\Parser\QueryParser($api, null, false);
        }
        throw new \UnexpectedValueException('Unknown protocol: ' . $api->getProtocol());
    }
    /**
    ...
    public function getOperation($name)
    {
        if (!isset($this->operations[$name])) {
            ...
            $this->operations[$name] = new \WP_Media_Folder\Aws\Api\Operation($this->definition['operations'][$name], $this->shapeMap);
        }
