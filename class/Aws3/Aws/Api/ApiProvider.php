...
use WP_Media_Folder\Aws\Exception\UnresolvedApiException;
/**
 * API providers.
 *
...
class ApiProvider
{
    ...
    public static function resolve(callable $provider, $type, $service, $version)
    {
        ...
        throw new \WP_Media_Folder\Aws\Exception\UnresolvedApiException($msg);
    }
    /**
    ...
    {
        return new self(__DIR__ . '/../data', \WP_Media_Folder\Aws\manifest());
    }
    /**
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \WP_Media_Folder\Aws\load_compiled_json($path);
