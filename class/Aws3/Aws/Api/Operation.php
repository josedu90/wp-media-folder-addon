 ...
 */
class Operation extends \WP_Media_Folder\Aws\Api\AbstractModel
{
    private $input;
    private $output;
    private $errors;
    ...
    public function getInput()
    {
        if (!$this->input) {
            if ($input = $this['input']) {
                ...
                $this->input = new \WP_Media_Folder\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->input;
    }
    ...
    public function getOutput()
    {
        if (!$this->output) {
            if ($output = $this['output']) {
                ...
                $this->output = new \WP_Media_Folder\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->output;
    }
