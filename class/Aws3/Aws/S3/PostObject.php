...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\WP_Media_Folder\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\WP_Media_Folder\Aws\Credentials\CredentialsInterface $creds)
    {
