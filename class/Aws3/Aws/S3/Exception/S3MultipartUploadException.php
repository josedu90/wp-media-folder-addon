...
namespace WP_Media_Folder\Aws\S3\Exception;

use WP_Media_Folder\Aws\CommandInterface;
use WP_Media_Folder\Aws\Exception\AwsException;
use WP_Media_Folder\Aws\Multipart\UploadState;
class S3MultipartUploadException extends \WP_Media_Folder\Aws\Exception\MultipartUploadException
{
     ...
     */
    public function __construct(\WP_Media_Folder\Aws\Multipart\UploadState $state, $prev = null)
    {
     ...
     */
    private function collectPathInfo(\WP_Media_Folder\Aws\CommandInterface $cmd)
    {
