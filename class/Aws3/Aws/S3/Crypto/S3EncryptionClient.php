...
namespace WP_Media_Folder\Aws\S3\Crypto;

use WP_Media_Folder\Aws\HashingStream;
use WP_Media_Folder\Aws\PhpHash;
use WP_Media_Folder\Aws\Crypto\AbstractCryptoClient;
use WP_Media_Folder\Aws\Crypto\EncryptionTrait;
use WP_Media_Folder\Aws\Crypto\DecryptionTrait;
use WP_Media_Folder\Aws\Crypto\MetadataEnvelope;
use WP_Media_Folder\Aws\Crypto\MaterialsProvider;
use WP_Media_Folder\Aws\Crypto\Cipher\CipherBuilderTrait;
 ...
 */
class S3EncryptionClient extends \WP_Media_Folder\Aws\Crypto\AbstractCryptoClient
{
     ...
     */
    public function __construct(\WP_Media_Folder\Aws\S3\S3Client $client, $instructionFileSuffix = null)
    {
        $this->client = $client;
    ...
    {
        return new \WP_Media_Folder\Aws\S3\Crypto\HeadersMetadataStrategy();
    }
    /**
    ...
    public function putObjectAsync(array $args)
    {
        ...
        $envelope = new \WP_Media_Folder\Aws\Crypto\MetadataEnvelope();
        return \WP_Media_Folder\GuzzleHttp\Promise\promise_for($this->encrypt(\WP_Media_Folder\GuzzleHttp\Psr7\stream_for($args['Body']), $args['@CipherOptions'] ?: [], $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
            $hash = new \WP_Media_Folder\Aws\PhpHash('sha256');
            $hashingEncryptedBodyStream = new \WP_Media_Folder\Aws\HashingStream($encryptedBodyStream, $hash, self::getContentShaDecorator($args));
