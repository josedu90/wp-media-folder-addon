...
use WP_Media_Folder\Aws\Crypto\MetadataStrategyInterface;
 ...
 */
class InstructionFileMetadataStrategy implements \WP_Media_Folder\Aws\Crypto\MetadataStrategyInterface
{
     ...
     *                            object keys.
     */
    public function __construct(\WP_Media_Folder\Aws\S3\S3Client $client, $suffix = null)
    {
     ...
     */
    public function save(\WP_Media_Folder\Aws\Crypto\MetadataEnvelope $envelope, array $args)
    {
    ...
    public function load(array $args)
    {
        ...
        $constantValues = \WP_Media_Folder\Aws\Crypto\MetadataEnvelope::getConstantValues();
