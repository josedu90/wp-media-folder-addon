...
use WP_Media_Folder\Aws\Multipart\AbstractUploadManager;
use WP_Media_Folder\Aws\ResultInterface;
use WP_Media_Folder\GuzzleHttp\Psr7;
class MultipartCopy extends \WP_Media_Folder\Aws\Multipart\AbstractUploadManager
{
    ...
    private function fetchSourceMetadata()
    {
        ...
        if (strpos($key, '?')) {
            ...
            $headParams['Key'] = $key;
            $query = \WP_Media_Folder\GuzzleHttp\Psr7\parse_query($query, false);
