    ...
    <div id="config_onedrive" class="div_list wpmf_width_100">
        ...
        if (!empty($onedrive_config['OneDriveClientId']) && !empty($onedrive_config['OneDriveClientSecret'])) {
            if (isset($onedrive_config['connected']) && (int)$onedrive_config['connected'] === 1) {
                ...
                $btndisconnect = '<a class="ju-button no-background orange-button waves-effect waves-light btndrive wpmf_onedrive_logout">' . __('Disconnect OneDrive', 'wpmfAddon') . '</a>';
        ...
        <div class="wpmf_width_100 ju-settings-option">
            ...
            <div class="m-t-60">
                <div class="wpmf_row_full" style="margin: 0; position: relative;">
                    ...
                    <div class="wpmf_copy_shortcode" data-input="redirect_uris_onedrive">
